...
const CATEGORY_IMAGES = {
  acne: [result1Img, result2Img, result3Img, result4Img, result2Img, result3Img, result1Img, result4Img],
  pigmentation: [result2Img, result3Img, result4Img, result1Img],
  dryness: [result3Img, result4Img, result1Img, result2Img],
  oily: [result4Img, result1Img, result2Img, result3Img],
};

export default function ResultSection() {
  const { t, get } = useI18n();
  const categories = get("result.categories", []);
  const [active, setActive] = useState(categories[0]?.key ?? "acne");
